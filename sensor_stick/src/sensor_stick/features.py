...
def features(ch_0, ch_1, ch_2, nbins, bins_range):
...
def compute_color_histograms(cloud, using_hsv=False):
    ...
    return features(channel_1_vals, channel_2_vals, channel_3_vals, nbins=32, bins_range=(0, 256))
...
def compute_normal_histograms(normal_cloud):
    ...
    return features(norm_x_vals, norm_y_vals, norm_z_vals, nbins=32, bins_range=(0, 256))
